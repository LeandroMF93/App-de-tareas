...
function agregarTarea( tarea,id,realizado,eliminado) {
    ...
    const elemento = `
                    ...
                    `
    lista.insertAdjacentHTML("beforeend",elemento) //utilizo el metodo insertAdjacentHTML https://developer.mozilla.org/es/docs/Web/API/Element/insertAdjacentHTML            
...
function tareaRealizada(element) {
    ...
    element.parentNode.querySelector('.text').classList.toggle(lineThrough) //uso ParentNode para ver los elementos Padre
...
function tareaEliminada(element){
   ...
   // console.log(element.parentNode.parentNode)
    element.parentNode.parentNode.removeChild(element.parentNode) //metodo para remover elemento Hijo
